    ...
    return (
        <div className="relative overflow-hidden">
            ...
            <div>
                ...
                <div>
                    {
                        donars.length > 0 ? <h1 className='text-3xl font-bold tracking-wider text-center mt-4'>No Donars Found</h1> : <><div class="mx-auto mt-24 grid w-10/12 grid-cols-1 md:grid-cols-3 gap-10 ">
