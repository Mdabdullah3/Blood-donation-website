...
const Contact = () => {
    return (
        <div>
            <section class="pt-40 mb-20">
                <div class="w-9/12 mx-auto font-mono">
                    <div class="flex flex-wrap lg:justify-between -mx-4">
                        <div class="w-full lg:w-1/2 xl:w-6/12 px-4">
                            <div class="mb-12 lg:mb-0">
                                <span class="block mb-2 text-xl text-primary font-semibold">
                                    Contact Us
                                </span>
                                <h2
                  ...
                  "
                     ...
                     "
                                ...
                                <div class="flex mb-8 max-w-[380px] w-full">
                                    <div
                                        class="
                     max-w-[60px]
                     sm:max-w-[70px]
                     ...
                     "
                        ...
                        <div class="w-full mt-4 lg:w-1/2 xl:w-5/12 px-4">
